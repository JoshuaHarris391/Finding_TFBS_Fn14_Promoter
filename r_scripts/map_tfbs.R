...
library('TFBSTools', lib.loc = './R_libs')
library('JASPAR2018', lib.loc = './R_libs')
library('tidyverse', warn.conflicts = F, lib.loc = './R_libs')
...
library('Biostrings', lib.loc = './R_libs')
library('seqinr', lib.loc = './R_libs')
