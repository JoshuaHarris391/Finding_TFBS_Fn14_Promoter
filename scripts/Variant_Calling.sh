...
java -jar $GATK_PATH Mutect2 -R ../data/hg19/hg19.fasta -I outputs/alignments/bam/chr16/${SRA_REF}_pass.chr16.aligned.sorted.bam --germline-resource ../data/gnomad_chr16/gnomad.genomes.r2.1.1.sites.16.liftover_grch38.vcf.bgz -O outputs/variant_calls/vcf/$SRA_REF.ch16.vcf.gz
